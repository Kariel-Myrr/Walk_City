...
class InventoryActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d(TAG, "InventoryActivity onCreate()")
        setContentView(activity_inventory)
        manager = Manager(this@InventoryActivity)
        manager.download()
        val city: CityData = manager.giveHomeCity()
        val resource: ItemResource = manager.giveHomeResource()
        var protection: ItemProtection = manager.giveHomeProtection()
        var weapon: ItemWeapon = manager.giveHomeWeapon()
        val popul = city.people
        val wood = resource.wood
        val iron = resource.iron
        val stone = resource.stone
        val food = resource.food
        val fuel = resource.fuel
        ...
        val swamp1 = findViewById<LinearLayout>(R.id.linearRes1)
        resourceList1.forEach {
            ...
            val txt1 = inflate.findViewById<TextView>(R.id.textView1)
            val txt2 = inflate.findViewById<TextView>(R.id.textView2)

            val draw = ContextCompat.getDrawable(this, it.imageResource)
    ...
    override fun onStart() {
        super.onStart()
        Log.d(TAG, "InventoryActivity onStart()")
    ...
    override fun onPause() {
        super.onPause()
        Log.d(TAG, "InventoryActivity onPause()")
        finish()
    }

    override fun onStop() {
        super.onStop()
        Log.d(TAG, "InventoryActivity onStop()")
    }

    override fun onDestroy() {
        super.onDestroy()
        Log.d(TAG, "InventoryActivity onDestroy()")
    }

    override fun onResume() {
        super.onResume()
        Log.d(TAG, "InventoryActivity onResume()")
    }
